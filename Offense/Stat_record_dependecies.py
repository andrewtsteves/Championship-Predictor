...
offensive_data = pd.read_csv('/Users/andrewsteves/PycharmProjects/Championship-Predictor'
                             '/Dataframes/offensive_data.csv')
defensive_data = pd.read_csv('/Users/andrewsteves/PycharmProjects/Championship-Predictor'
                             '/Dataframes/defensive_data.csv')
